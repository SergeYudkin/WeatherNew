...
import com.example.weathernew.databinding.FragmentHistoryRecyclerCityItemBinding
import com.example.weathernew.model.Weather
import com.example.weathernew.view.main.OnMyItemClickListener

class CitiesHistoryAdapter(val listener: OnMyItemClickListener): RecyclerView.Adapter<CitiesHistoryAdapter.HistoryCityViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CitiesHistoryAdapter.HistoryCityViewHolder {
        val binding: FragmentHistoryRecyclerCityItemBinding = FragmentHistoryRecyclerCityItemBinding
